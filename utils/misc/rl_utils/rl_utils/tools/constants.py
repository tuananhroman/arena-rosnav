...
class TRAINING_CONSTANTS(object):
    class PATHS(object):
        ...
        def TRAINING_CONFIGS(file_name):
            return os.path.join(TRAINING_CONSTANTS.PATHS.CONFIGS, "training", file_name)

        def REWARD_FUNCTIONS(file_name):
            return os.path.join(
