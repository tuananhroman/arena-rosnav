...
class TaskGenerator(NodeInterface.Taskgen_T):
    ...
    def _cb_get_configs_environments(
        ...
        response.environments = (
            arena_simulation_setup.configs.environment.Environment.list()
        )
        return response
    ...
    def _cb_get_configs_parametrized(
        ...
        response.parametrizeds = (
            arena_simulation_setup.configs.parametrized.Parametrized.list()
        )
        return response
    ...
    def _set_up_services(self):
        # Services
        self.create_service(
            EmptySrv, self.service_namespace("reset_task"), self._cb_reset_task
        )
